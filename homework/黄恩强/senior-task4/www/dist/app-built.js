...
define('app/exposure',['jquery'], function ($) {
...
define('app/nav',['jquery', 'app/exposure'], function ($, exposure) {
    function nav($target) {
        this.init($target)
...
define('app/shrink',['jquery',], function ($) {
...
define('app/slider',['jquery'], function ($) {
...
//  4.  使用 r.js 打包应用
define('app/main',['jquery', 'app/nav', 'app/shrink', 'app/slider', 'app/gotop', 'app/waterfall'], function ($, nav, shrink, slider, gotop, waterfall) {
    shrink.open($('.navbar'))
    nav.open($('.navbar .nav'))
